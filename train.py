...
train_molecules_input = molecules_input[:num_train_data]
test_molecules_input = molecules_input[num_train_data:-1]

train_molecules_output = molecules_output[:num_train_data]
...
for epoch in range(args.num_epochs):
    ...
    for _ in range(len(train_molecules_input)//args.batch_size):
    ...
    for _ in range(len(test_molecules_input)//args.batch_size):
    ...
    ckpt_path = f'{args.save_dir}/model_{str(epoch)}.ckpt'
